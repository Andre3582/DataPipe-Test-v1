var jsPsychFreeSortCustom = (function (jspsych) {
  'use strict';FreeSortCustom
  ...
  class FreeSortCustomPlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
              "<div " +
                  'id="jspsych-free-sort-custom-border" ' +
                  'class="jspsych-free-sort-custom-border" ' +
                  'style="position: relative; width:' +
          ...
          const html_text = '<div style="line-height: 1.0em;">' +
              trial.prompt +
              '<p id="jspsych-free-sort-custom-counter" style="display: inline-block;">' +
          ...
          // add button
          html +=
              '<div><button id="jspsych-free-sort-custom-done-btn" class="jspsych-btn" ' +
          ...
          for (let i = 0; i < stimuli.length; i++) {
              ...
              display_element.querySelector("#jspsych-free-sort-custom-arena").innerHTML +=
                  "<img " +
                      'src="' +
                      stimuli[i] +
                      '" ' +
                      ...
                      'draggable="false" ' +
                      'id="jspsych-free-sort-custom-draggable-' +
                      i +
                      '" ' +
          ...
          let cur_in = false;
          // draggable items
          const draggables = display_element.querySelectorAll(".jspsych-free-sort-custom-draggable");
          // button (will show when all items are inside) and border (will change color)
          const border = display_element.querySelector("#jspsych-free-sort-custom-border");
          const button = display_element.querySelector("#jspsych-free-sort-custom-done-btn");
          ...
          if (inside.every(Boolean)) {
              ...
              display_element.querySelector("#jspsych-free-sort-custom-counter").innerHTML =
          ...
          for (let i = 0; i < draggables.length; i++) {
              draggables[i].addEventListener(start_event_name, (event) => {
                  ...
                  let move_event = (e) => {
                      ...
                      var elem_number = parseInt(elem.id.split("jspsych-free-sort-custom-draggable-")[1], 10);
          ...
          display_element.querySelector("#jspsych-free-sort-custom-done-btn").addEventListener("click", () => {
              if (inside.every(Boolean)) {
                  const end_time = performance.now();
                  const rt = Math.round(end_time - start_time);
                  // gather data
                  const items = display_element.querySelectorAll(".jspsych-free-sort-custom-draggable");
  ...
  FreeSortCustomPlugin.info = info;

  return FreeSortCustomPlugin;
